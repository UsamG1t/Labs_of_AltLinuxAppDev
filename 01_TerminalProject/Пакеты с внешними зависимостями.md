...
`admin`
```console
[admin@VM ~]$ hsh-install ncursesw-devel  
...
`admin`
```console
[admin@VM ~]$ cp hasher/chroot/usr/src/RPM/RPMS/x86_64/ncursesw-1.0-alt1.x86_64.rpm  hasher/chroot/.in/  
...
`admin`
```console
[admin@VM ~]$ cp hasher/chroot/usr/src/RPM/RPMS/x86_64/ncursesw-1.0-alt1.x86_64.rpm .  
[admin@VM ~]$ hsh --init  
<...>
[admin@VM ~]$ cp ncursesw-1.0-alt1.x86_64.rpm hasher/chroot/.in/  
[admin@VM ~]$ hsh-shell --rooter  
```
...
`admin`
```console
[admin@VM ~]$ hsh-install ncursesw libncursesw6
<...>
[admin@VM ~]$ cp ncursesw-1.0-alt1.x86_64.rpm hasher/chroot/.in/  
[admin@VM ~]$ hsh-shell --rooter  
```
...
`admin`
```console
[admin@VM ~]$ cp hasher/chroot/usr/src/RPM/RPMS/x86_64/ncursesw-1.1-alt1.x86_64.rpm hasher/chroot/.in/  
[admin@VM ~]$ hsh-shell --rooter  
```
