...
<13>Jul 10 08:39:14 rpmi: libncurses6-6.3.20220618-alt4 sisyphus+327286.4600.14.1 1711486705 installed  
<13>Jul 10 08:39:14 rpmi: libtinfo-devel-6.3.20220618-alt4 sisyphus+327286.4600.14.1 1711486705 installed  
<13>Jul 10 08:39:14 rpmi: libncurses-devel-6.3.20220618-alt4 sisyphus+327286.4600.14.1 1711486705 installed  
[user@VM ~]$
```
...
       libncurses.so.6()(64bit) >= set:mi6NHG6gUJ4yHTS2FoKH5hxjh80KggmL6K9X2A2 is needed by ncurses-1.0-alt1.x86_64  
       ncurses < 6.3.20220618-alt4 conflicts with (installed) terminfo-6.3.20220618-alt4.noarch  
[root@localhost .in]#
```
...
```console
[root@localhost .in]# rpm -i pkg-ncurses-1.0-alt1.x86_64.rpm    
<13>Jul  8 20:26:08 rpm: pkg-ncurses-1.0-alt1 1752005332 installed  
                                                              [root@localhost .in]#    
...
libncurses.so.6()(64bit) >= set:njzUlMJGoZaFrOm1ipLX6ub3NlTS2FoKH5pxjl802  
rpmlib(SetVersions)     
