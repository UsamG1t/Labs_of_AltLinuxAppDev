...
Соберём пакет, программы в котором будут выполнять роль утилиты `grep`. Для сборки воспользуемся [`gear`](https://docs.altlinux.org/ru-RU/alt-platform/10.1/html-single/alt-platform/index.html#gear--chapter) — утилитой, которая позволяет 
