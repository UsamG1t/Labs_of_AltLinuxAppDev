...
**TODO** Что-то пользователь у вас то `user`, то `papillon_jaune` — в этом есть смытый скрысл?
...
[papillon_jaune@usamg1tVM ~]$ strace date
...
**TODO** ↑ сюда добавить пояснений, что делает эта программа и что в целом будут делать stracve inject-ы
...
**TODO** ↑ сюда добавить пояснение, что именно делают strace inject-ы и что мы проверяем 

**TODP** ↓ сюда добавтиь пояснение, что это за файлы такие
