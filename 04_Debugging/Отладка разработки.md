...
Данный сценарий позволяет:
 + Инициализировать чистое окружение
 + Разворачивать окружение вокруг пакета с исходным кодом
 + Устанавливать пакеты в `hasher` при инициализации нового окружения

Автоматически при создании окружения в него будут добавляться монтирование специальных файловых систем, выход в интернет и минимальный набор пакетов для работы. По желанию можно дополнительно указать пакеты для установки
