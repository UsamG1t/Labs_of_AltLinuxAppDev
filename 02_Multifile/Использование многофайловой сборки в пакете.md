...
+ Оба варианта сборки программы с библиотекой — вида `cc файлы.o libбиблиотека -o программа` и вида `cc файлы.o -Lпуть_к_библиотеке -lбиблиотека -o программа` — годятся и для статической, и для динамической сборок. Второй вариант предпочтительнее.
